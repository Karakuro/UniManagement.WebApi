    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamTrainer", x => new { x.ExamsExamId, x.TrainersTrainerId });
                    table.ForeignKey(
                        name: "FK_ExamTrainer_Exams_ExamsExamId",
                        column: x => x.ExamsExamId,
                        principalTable: "Exams",
                        principalColumn: "ExamId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamTrainer_Trainers_TrainersTrainerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamTrainer_TrainersTrainerId",
                table: "ExamTrainer",
